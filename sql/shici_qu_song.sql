...
--
-- Table structure for table `qu_song`
--

DROP TABLE IF EXISTS `qu_song`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `qu_song` (
...
--
-- Dumping data for table `qu_song`
--

LOCK TABLES `qu_song` WRITE;
/*!40000 ALTER TABLE `qu_song` DISABLE KEYS */;
/*!40000 ALTER TABLE `qu_song` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-10-14  8:37:09
